...
namespace A4_MaCrizzaRegacho
{
    ...
    public class AdventureTest
    {
        ...
        {
            ClassicAssert.Throws<ArgumentNullException>(() => new Adventure(null));
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new Adventure("NOT A REAL FILE.TXT"));
        }
        ...
        public static void Adventure_Constructor_Test()
        {
            ...
            ClassicAssert.AreNotEqual(null, adventure);
            ClassicAssert.AreNotEqual(null, adventure.BackPack);

            // NOTE: you need access to the internal Hash Map for this to work!
            ClassicAssert.AreEqual(22, adventure.BackPack.Size); // property
           // ClassicAssert.AreEqual(22, adventure.GetMap().Size()); // getter method
        }
        #endregion
        ...
        public static void PrintLootMap()
        {
            ...
            ClassicAssert.AreEqual(expectedResult, adventure.PrintLootMap());
        }
        #endregion
