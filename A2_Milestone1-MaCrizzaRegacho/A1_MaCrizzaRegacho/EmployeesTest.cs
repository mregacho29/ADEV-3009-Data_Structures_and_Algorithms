...
namespace A1_MaCrizzaRegacho
{
    ...
    public class EmployeesTest
    {
        ...
        public void EmployeeId_Constructor_Test()
        {
            ...
            ClassicAssert.That(employee, Is.Not.Null);
            ClassicAssert.That(employee.EmployeeID, Is.EqualTo(employeeId));
            ClassicAssert.That(employee.FirstName, Is.EqualTo(null));
            ClassicAssert.That(employee.LastName, Is.EqualTo(null));
        ...
        public void FullEmployee_Constructor_Test()
        {
            ...
            ClassicAssert.That(employee, Is.Not.Null);
            ClassicAssert.That(employee.EmployeeID, Is.EqualTo(employeeId));
            ClassicAssert.That(employee.FirstName, Is.EqualTo(firstName));
            ClassicAssert.That(employee.LastName, Is.EqualTo(lastName));
        }
        #endregion
        ...
        public void CompareTo_First_is_Lower_Test()
        {
            ...
            ClassicAssert.That(employee1.CompareTo(employee2), Is.LessThan(0));
        ...
        public void CompareTo_First_is_Higher_Test()
        {
            ...
            ClassicAssert.That(employee1.CompareTo(employee2) > 0);
        ...
        public void CompareTo_Equal_Test()
        {
            ...
            ClassicAssert.That(e1.CompareTo(e2) == 0);
        }
        ...
        public void ToString_Test()
        {
            ...
            ClassicAssert.That(employee.ToString(), Is.EqualTo(expectedToString));
        }
        ...
        /// </summary>
        [Test]
        public void ToString_overrides_object_Test()
        {
            int employeeId = 1;
            string firstName = "First";
            string lastName = "Employee";
            ...
            object o = employee;
            string expectedToString = $"{employeeId} {firstName} {lastName}";
            ClassicAssert.That(o.ToString(), Is.EqualTo(expectedToString));
        }
