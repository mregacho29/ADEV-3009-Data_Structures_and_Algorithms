...
//            string mazeOutput = maze.BreadthFirstSearch();
//            ClassicAssert.That(mazeOutput, Is.EqualTo(breadthStringPath + basicMazeBreadthSearched));
//        }
//        #endregion
...
//            while (!path.IsEmpty())
//            {
//                ClassicAssert.That(path.Pop().ToString(), Is.EqualTo(breathStackPath.Pop().ToString()));
//            }
//        }
...
//            while (!path2.IsEmpty())
//            {
//                ClassicAssert.That(path2.Pop().ToString(), Is.EqualTo(breathStackPath.Pop().ToString()));
//            }
//        }
//        #endregion
//    }
