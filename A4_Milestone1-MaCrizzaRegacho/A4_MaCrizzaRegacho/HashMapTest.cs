...
namespace A4_MaCrizzaRegacho
{
    ...
    public class HashMapTest
    {
        ...
        public static void HashMapNoArgConstructorTest()
        {
            ...
            ClassicAssert.AreNotEqual(null, newHashMap);
            ClassicAssert.AreEqual(newHashMap.Table.Length, 11);
            ClassicAssert.AreEqual(newHashMap.Size, 0);
        ...
        public static void HashMapOneArgConstructorTest()
        {
            ...
            ClassicAssert.AreNotEqual(null, newHashMap);
            ClassicAssert.AreEqual(newHashMap.Table.Length, 5);
            ClassicAssert.AreEqual(newHashMap.Size, 0);
        }
        ...
        public static void HashMapTwoArgConstructorTest()
        {
            ...
            ClassicAssert.AreNotEqual(null, newHashMap);
            ClassicAssert.AreEqual(newHashMap.Table.Length, 7);
            ClassicAssert.AreEqual(newHashMap.Size, 0);
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new HashMap<StringKey, Item>(0));
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new HashMap<StringKey, Item>(-1));
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new HashMap<StringKey, Item>(0, 0.75));
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new HashMap<StringKey, Item>(-1, 0.75));
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new HashMap<StringKey, Item>(1, -1));
        }
        ...
        {
            ClassicAssert.Throws<ArgumentException>(() => new HashMap<StringKey, Item>(0, 2));
        }
        #endregion
        ...
        public static void Put_Throws_Exception_With_Null_Key_Test()
        {
            ...
            ClassicAssert.Throws<ArgumentNullException>(() => hashMap.Put(null, item));
        }
        ...
        public static void Put_Throws_Exception_With_Null_Value_Test()
        {
            ...
            ClassicAssert.Throws<ArgumentNullException>(() => hashMap.Put(key, null));
        }
        ...
        public static void Put_Returns_Null_when_a_new_insert_Test()
        {
            ...
            ClassicAssert.AreEqual(null, hashMap.Put(key, item));
        }
        ...
        public static void Put_increases_size_Test()
        {
            ...
            ClassicAssert.AreEqual(1, hashMap.Size);
        }
        ...
        public static void Put_Adds_Value_To_Hash_Test()
        {
            ...
            ClassicAssert.AreEqual(item, table[bucket].Value);
        }
        ...
        public static void Put_Returns_Replaced_Value_On_Update_Test()
        {
            ...
            ClassicAssert.AreEqual(item01, hashMap.Put(key, item02));
        }
        ...
        public static void Put_Overwrites_Value_At_Key_On_Update_Test()
        {
            ...
            ClassicAssert.AreEqual(newItem, table[bucket].Value);
        ...
        public static void Put_uses_linear_probing_on_collisions_Test()
        {
            ...
            ClassicAssert.AreEqual(bucket1, bucket2);
            ...
            ClassicAssert.AreEqual(item2Value, table[((bucket1+1) % table.Length)].Value);
        }
        ...
        public static void Put_increases_table_size_on_default_constructor_at_75_percent_of_11_Test()
        {
            ...
            ClassicAssert.AreEqual(capacity, hashMap.Table.Length);
            ClassicAssert.AreEqual(threshold - 1, hashMap.Size);

            hashMap.Put(new StringKey("item" + i), new Item("item" + i, i, 0.0 + i));
            
            // the next prime after 11 is 11*2 = 22... and 22+1 is 23!
            ClassicAssert.AreEqual(23, hashMap.Table.Length);
            ClassicAssert.AreEqual(threshold, hashMap.Size);
        }
        ...
        public static void Put_increases_table_size_on_custom_size_constructor_at_75_percent_Test()
        {
            ...
            ClassicAssert.AreEqual(11, hashMap.Table.Length);
            ClassicAssert.AreEqual(threshold, hashMap.Size);
        }
        ...
        public static void Put_increases_table_size_on_custom_capacity_with_a_custom_loadfactor_Test()
        {
            ...
            ClassicAssert.AreEqual(17, hashMap.Table.Length);
            ClassicAssert.AreEqual(threshold, hashMap.Size);
        }

        /// <summary>
        /// Test Put updates bucket after rehash.
        /// </summary>
        [Test]
        public static void Put_uses_the_new_table_length_for_bucket_after_rehash_test()
        {
            HashMap<StringKey, Item> hashMap = new HashMap<StringKey, Item>();
            for (int i = 0; i < 15; i++)
            {
            ...
            foreach (Entry<StringKey, Item> entry in hashMap.Table)
            {
                if (entry != null)
                {
                    // look up each item in the hashmap, using the keys, they should all be there!
                    Item currItem = hashMap.Get(entry.Key);
                    ClassicAssert.IsNotNull(currItem);
                    ClassicAssert.AreEqual(entry.Value, currItem);
                }
            }
        }
        #endregion
        ...
        public static void HashMapIsEmptyReturnsTrueTest()
        {
            ...
            ClassicAssert.IsTrue(hashMap.IsEmpty());
        }
        ...
        public static void HashMapIsEmptyReturnsFalseTest()
        {
            ...
            ClassicAssert.IsFalse(hashMap.IsEmpty());
        }
        #endregion
        ...
        public static void ClearEmptiesTableTest()
        {
            ...
            ClassicAssert.AreEqual(null, hashMap.Get(key));
            ClassicAssert.IsTrue(hashMap.IsEmpty());
            ClassicAssert.AreEqual(0, hashMap.Size);
        }
        #endregion
        ...
        public static void GetMatchingOrNextAvailableBucket_Retuns_index_of_key_Test()
        {
            ...
            ClassicAssert.AreEqual(index, hashMap.GetMatchingOrNextAvailableBucket(key));
        }
        ...
        public static void GetMatchingOrNextAvailableBucket_Retuns_next_index_when_collision_occurs_Test()
        {
            ...
            ClassicAssert.AreEqual(index + 1, hashMap.GetMatchingOrNextAvailableBucket(key));
        }
        ...
        public static void GetMatchingOrNextAvailableBucket_Retuns_index_on_collision_entry_Test()
        {
            ...
            ClassicAssert.AreEqual(secondIndex, hashMap.GetMatchingOrNextAvailableBucket(key));
            ClassicAssert.AreNotEqual(secondIndex, firstIndex);
        }
        ...
        public static void GetMatchingOrNextAvailableBucket_Retuns_0_index_when_collision_on_last_bucket_occurs_Test()
        {
            ...
            ClassicAssert.AreEqual(hashMap.Table.Length-1, index);
            
            // we overwrite the spot that item originally hashes to...
            hashMap.Table[index] = new Entry<StringKey, Item>(collisionKey, item);

            // test to see if the next bucket is index 0 during a collision
            ClassicAssert.AreEqual(0, hashMap.GetMatchingOrNextAvailableBucket(key));
        }
        ...
        public static void Get_Retuns_Value_of_key_Test()
        {
            ...
            ClassicAssert.AreEqual(item, hashMap.Get(key));
            ClassicAssert.AreEqual(1, hashMap.Size); // size should remain 1
        }
        ...
        public static void Get_uses_linear_probing_on_collisions_Test()
        {
            ...
            ClassicAssert.AreEqual(2, hashMap.Size);

            ClassicAssert.AreEqual(item2Value, hashMap.Get(new StringKey("Helmet")));
        }
        ...
        public static void Remove_Returns_Removed_Value_Test()
        {
            ...
            ClassicAssert.AreEqual(item, returnedItem);
        }
        ...
        public static void Remove_Returns_null_or_default_Value_when_no_match_exists_Test()
        {
            ...
            ClassicAssert.IsTrue(returnedItem == null || default(Item) == returnedItem);
        }
        ...
        public static void Remove_Throws_Exception_With_Null_Key_Test()
        {
            ...
            ClassicAssert.Throws<ArgumentNullException>(() => hashMap.Remove(null));
        }
        ...
        public static void Remove_keeps_a_key_placeholder_Test()
        {
            ...
            ClassicAssert.AreEqual(table[bucket].Key, key);
            ClassicAssert.AreEqual(table[bucket].Value, null);
        }
        ...
        public static void Remove_placeholders_count_towards_resize_Test()
        {
            ...
            ClassicAssert.AreEqual(threshold - 2, hashMap.Size);
        ...
        public static void Remove_uses_linear_probing_on_collisions_Test()
        {
            ...
            //remove returns the right value.
            ClassicAssert.AreEqual(item2Value, hashMap.Remove(new StringKey("Helmet")));

            // remove reduces the size
            ClassicAssert.AreEqual(1, hashMap.Size);

            // remove leaves a placeholder.
            ClassicAssert.AreEqual(null, table[((bucket1 + 1) % table.Length)].Value);
        }

        /// <summary>
        /// Updating a placeholder causes the size to increase. 
        /// </summary>
        [Test]
        public static void Remove_creates_placeholder_put_on_placeholder_increases_size_Test()
        {
            ...
            hashMap.Put(new StringKey("item1"), new Item("item", 1, 1));

            ClassicAssert.AreEqual(1, hashMap.Size);

            // removes item 1, created a placeholder
            hashMap.Remove(new StringKey("item1"));

            ClassicAssert.AreEqual(0, hashMap.Size);

            // updates the placeholder, therefore increases the size (reducing an local placeholder variable count)
            hashMap.Put(new StringKey("item1"), new Item("item", 1, 1));
        ...
        {
            HashMap<StringKey, Item> hashMap = new HashMap<StringKey, Item>(23);
            ...
            IEnumerable<StringKey> keys = hashMap.Keys();

            int count = 0;
            foreach (var key in hashMap.Keys())
            {
                // look up each item in the hashmap, using the keys, they should all be there!
                Item currItem = hashMap.Get(key);
                ClassicAssert.IsNotNull(currItem);
                count++;
            }

            ClassicAssert.AreEqual(hashMap.Size, count);
        }
        #endregion
        ...
        public static void Values_returns_list_of_Values_Test()
        {
            ...
            // get the keys for the map
            IEnumerable<Item> keys = hashMap.Values();

            int count = 0;

            foreach (var item in hashMap.Values())
            {
                StringKey currKey = new StringKey(item.Name);
                ...
                ClassicAssert.AreEqual(matchValue, item);
