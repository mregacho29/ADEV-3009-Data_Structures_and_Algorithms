...
namespace TestLibrary
{
    ...
    public class ItemTest
    {
        ...
        public static void ItemConstructorTest()
        {
            ...
            Item item = new Item(Name, GoldPieces, Weight);

            ClassicAssert.AreEqual(Name, item.Name);
            ClassicAssert.AreEqual(GoldPieces, item.GoldPieces);
            ClassicAssert.AreEqual(Weight, item.Weight);
        }
        ...
        public static void ToStringTest()
        {
            ...
            ClassicAssert.AreEqual(expectedResult, item.ToString());
        }
        ...
        public static void CompareToSameObjectTest()
        {
            ...
            ClassicAssert.AreEqual(expectedResult, comparableItem.CompareTo(item));
        }
        ...
        public static void CompareToSameNameTest()
        {
            ...
            ClassicAssert.AreEqual(expectedResult, item1.CompareTo(item2));
        ...
        public static void CompareToAphabeticallyBeforeNameTest()
        {
            ...
            ClassicAssert.IsTrue(item1.CompareTo(item2) > 0);
        }
        ...
        public static void EqualsSameObjectTest()
        {
            Item item = new Item("Item", 10, 5.0);
            object objItem = item;
            ClassicAssert.IsTrue(objItem.Equals(objItem));
        }
        ...
        public static void EqualsNullObjectTest()
        {
            ...
            ClassicAssert.IsFalse(objItem.Equals(null));
        }
        ...
        public static void EqualsNonItemObjectTest()
        {
            ...
            ClassicAssert.IsFalse(objItem.Equals("Not an item"));
        }
        ...
        public static void EqualsDifferentObjectsWithMatchingNameTest()
        {
            ...
            ClassicAssert.IsTrue(objItem.Equals(objItem2));
        }
        ...
        public static void EqualsMisMatchedObjects_name_values_differ_Test()
        {
            ...
            ClassicAssert.IsFalse(objItem.Equals(objItem2));
        }
